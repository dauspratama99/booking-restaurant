...
<div class="content remove_pad" onclick="remove_class()">
	...
	<div class="inner_content on_parallax">
		...
		<div class="order_holder">
			...
			<p class="summary_p">Selamar transaksi Anda <?php echo $name; ?> berhasil. <span>Order number</span> anda: <?php echo $order_id; ?>. Harap dicatat bahwa nomor pesanan Anda harus tetap aman.</p>
