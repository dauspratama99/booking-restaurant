<?php 
    ...
    $date_filter_mulai = (isset($_GET['date_mulai']) ? $_GET['date_mulai'] : '');
		...
		// $cat = $db->query("SELECT * FROM reservation WHERE date_made like '$date_filter%' LIMIT $start, $per_page");
        $cat = $db->query("SELECT * FROM reservation WHERE (date_res between '$date_filter_mulai' and '$date_filter') LIMIT $start, $per_page");
        ...
        if (isset($_GET['status'])) {
            ...
            if(isset($status)){
                if ($status == "confirm") {
                    $query = $db->query("SELECT * FROM reservation WHERE status ='confirmed'");
                    $result = "<table class='table table-hover table-striped'>
                    <thead>
                        <th>S/N</th>
                        <th>Customer Name</th>
                    ...
                    $query = $db->query("SELECT * FROM reservation WHERE status='pending'");
